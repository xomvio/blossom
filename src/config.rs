...
pub const DEFAULT_CREATE_PORT: &str = "9191";

/// Default port for joining a room
pub const DEFAULT_JOIN_PORT: &str = "9192";

/// Server port for Yggdrasil communication
pub const SERVER_PORT: &str = "9595";
...
pub const YGGDRASIL_CONF_PATH: &str = "/tmp/yggdrasil.conf";

/// Yggdrasil log file path
pub const YGGDRASIL_LOG_PATH: &str = "/tmp/yggdrasil.log";

/// Default Yggdrasil peer (Armenian public peer)
pub const DEFAULT_YGGDRASIL_PEER: &str = "quic://37.186.113.100:1515";
